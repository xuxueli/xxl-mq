...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			...
			<span class="logo-lg"><b>分布式消息队列</b></span>
		</a>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click" ><a href="${request.contextPath}/mq"><i class="fa fa-circle-o text-red"></i> <span>消息管理</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
			...
			<a href="http://my.oschina.net/xuxueli/blog/738918" target="_blank" >oschina</a>
