package com.xxl.mq.admin.business.service.impl;

import com.xxl.mq.admin.business.constant.enums.ArchiveStrategyEnum;
import com.xxl.mq.admin.business.mapper.MessageArchiveMapper;
import com.xxl.mq.admin.business.mapper.TopicMapper;
import com.xxl.mq.admin.business.model.adaptor.MessageAdaptor;
import com.xxl.mq.admin.business.model.dto.MessageArchiveDTO;
import com.xxl.mq.admin.business.model.entity.MessageArchive;
import com.xxl.mq.admin.business.model.entity.Topic;
import com.xxl.mq.admin.business.service.MessageAichiveService;
...
public class MessageArchiveServiceImpl implements MessageAichiveService {
	...
	*/
	...
	public PageModel<MessageArchiveDTO> pageList(int offset, int pagesize, String topic, int status, long bizId, Date effectTimeStart, Date effectTimeEnd) {
		...
		// page
		List<MessageArchive> pageList = messageArchiveMapper.pageList(offset, pagesize, topic, status, bizId, effectTimeStart, effectTimeEnd);
		int totalCount = messageArchiveMapper.pageListCount(offset, pagesize, topic, status, bizId, effectTimeStart, effectTimeEnd);
