package com.xxl.mq.admin.business.constant.enums;

import com.xxl.mq.admin.business.broker.router.PartitionRouter;
import com.xxl.mq.admin.business.broker.router.impl.*;
...
public enum PartitionRouteStrategyEnum {
    ...
    CYCLE(2, "轮询", new CyclePartitionRouter()),
    RANDOM(3, "随机", new RandomPartitionRouter()),
