...
<body>
    ...
    <table>
        ...
        <tr>
            <td>topic_sample</td>
            <td>并行消息：Topic 路由策略 = “轮询”（或选择 “随机”）</td>
            <td>
        ...
        <tr>
            ...
            <td>串行消息：Topic 路由策略 = “第一个”（或选择 “最后一个”）</td>
            <td>
        ...
        <tr>
            ...
            <td>分片消息：Topic 路由策略 = “Hash”；且生产消息时，自定义消息bizId （作为 “分区hash“ 的 ”业务参数“ ） </td>
            <td>
        ...
        <tr>
            ...
            <td>延时消息：生产消息时，生效时间设置为 3min 后（支持自定义）；</td>
            <td>
        ...
        <tr>
            ...
            <td>失败重试消息：Topic 重试次数 = 3（支持自定义）；</td>
            <td>
