...
- 1、底层long polling监控keys非法去重问题修复；
- 2、注册逻辑优化，批量注册，提高注册性能，降低注册中心压力；
- 3、示例项目中提供功能测试、性能测试用例，以及消息生产、消费、成功率等方便的数据分析；参考章节 “2.6 功能测试 & 性能测试”。测试数据显示 10000 条消息 2s 内 100% 投递只消息中心，且后续被 100% 成功消费；
