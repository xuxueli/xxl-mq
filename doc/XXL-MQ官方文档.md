...
### 6.7 版本 v1.4.0 Release Notes[2025-05-24]
...
- 1、【优化】客户端SDK终止逻辑优化，避免启动失败时销毁异常；
- 2、【优化】客户端SDK消息校验逻辑优化，针对非法topic(长度>100)与非法数据(长度>4000)，主动输出错误日志、辅助快速定位业务问题；
- 3、【优化】消息失败告警巡检SQL问题修复；
- 4、【TODO】消费者线程优化：单消费者支持多线程并行消费；
- 5、【TODO】消息管理界面优化：支持 生效时间、新增时间 多种排序方式；
