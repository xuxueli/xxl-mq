...
### 5.5 版本 v1.2.2 Release Notes[迭代中]
- 访问令牌（accessToken）：为提升系统安全性，消息中心和客户端进行安全性校验，双方AccessToken匹配才允许通讯；
- 支持批量注册、摘除，提升注册发现性能；升级 xxl-rpc 至 v1.3.1;
- [迭代中]客户端取消Consumer非空的限制；
